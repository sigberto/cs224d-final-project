...
class QASystem(object):
    ...
    def setup_system(self):
        ...
        # step 2
        p_states, p_last_state = self.encoder.encode_w_gru_attn(self.paragraph_var, self.paragraph_mask,
        ...
        # step 4
        self.a_s, self.a_e = self.decoder.decode(p_4_last_state, q_last_state)
